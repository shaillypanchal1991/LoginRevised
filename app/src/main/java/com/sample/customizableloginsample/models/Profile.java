...
import com.sample.loginkit.models.Preferences;
...
public class Profile {
    ...
    public static void loadImage(ImageView view, String imageUrl) {
        Glide.with(view.getContext())
                .load(imageUrl).error(R.drawable.ic_plus).fallback(R.drawable.ic_plus).apply(DataStore.getInstance().getrequestoptions())
                .into(view);
    }
